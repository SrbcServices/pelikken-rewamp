                        ...
                        <div class="slider_demo2">
                            <div class="single_post post_type6 xs-mb30">
                                ...
                                <div class="single_post_text" style="padding: 18px 20px">
                                    <div class="meta meta_separator1"> <a href="/news/{{ $news->category->slug }}">{{
                                            $news->category->category_name }}</a>
                                        <a href="#">{{ $news->local }}</a>
                                    </div>
                                    <h4><a class="" href="/pelikken/news/{{ $news->slug }}">{{
                        ...
                        <div class="slider_demo2">
                            <div class="single_post post_type6 xs-mb30">
                                ...
                                <div class="single_post_text" style="padding: 18px 12px">
                                    ...
                                    <h6><a href="/pelikken/news/{{ $news->slug }}" class="small"
                                            style="font-size: 18px;line-height:20px;">{{ substr($news->NewsHeading, 0,
                                            60) }}</a>
                                    </h6>
            ...
            <div class="carousel_post2_type3 nav_style1 owl-carousel">
                ...
                @if ($index < 4) <div class="single_post post_type3">
                    ...
                    <div class="single_post_text">
                        <div class="meta3"> <a href="news/{{ $news->category->category_name }}">{{
                                $news->category->category_name }}</a>
                            <a href="#">{{ $news->local }}</a>
                        </div>
    ...
    <div class="widget tab_widgets mb30">
        ...
        <div class="post_type2_carousel owl-carousel nav_style1">
            ...
            <div class="single_post2_carousel">
                ...
                @if ($index <= 6) <div class="single_post widgets_small type8">
                    <div class="post_img">
                        <div class="img_wrap">
                            <img src="{{ asset('uploads/news/' . $news->ThumbImage . '') }}" alt="">
                        </div>
                    ...
                    <div class="single_post_text">
                        <div class="meta2"> <a href="/news/{{ $news->category->category_name }}">{{
                                $news->category->category_name }}</a>
                            <a href="#">{{ $news->local }}</a>
                        </div>
                        <h4><a href="/pelikken/news/{{ $news->slug }}">{{ substr($news->NewsHeading, 0, 60) }}</a>
                        </h4>
                    </div>
                    ...
                    <div class="single_post widgets_small">
                        ...
                        <div class="single_post_text">
                            ...
                            <h4>
                                ...
                                <a>
                                    <h4><a href="/news/{{ $news->slug }}">{{ substr($news->NewsHeading, 0, 60) }}</a>
                                    </h4>
                                </a>
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-md-6">
                            <div class="single_post post_type3 mb30">
                                ...
                                <div class="single_post_text">
                                    <div class="meta3"> <a href="/news/{{ $news->category->slug }}">{{
                                            $news->category->category_name }}</a>
                                        <a href="#">{{ $news->local }}</a>
                                    </div>
                                    <h4><a href="/pelikken/news/{{ $news->slug }}">{{ $news->NewsHeading }}</a>
                                    </h4>
                                    <div class="space-10"></div>
            ...
            <div class="widget mb30">
                ...
                <div class="widget4_carousel owl-carousel nav_style1">
                    ...
                    <div class="carousel_items">
                        ...
                        @if ($index < 8) <div class="single_post widgets_small widgets_type4">
                            ...
                            <div class="single_post_text">
                                ...
                                <h4><a href="/pelikken/news/{{ $news->slug }}">{{ substr($news->NewsHeading, 0, 60)
                                        }}</a>
                                </h4>
                                <div class="space-15"></div>
                                <div class="border_black"></div>
                ...
                <div class="carousel_items">
                    ...
                    @if ($index > 8 && $index < 16) <div class="single_post widgets_small widgets_type4">
                        <div class="post_img number">
                            <img src="{{ asset('uploads/news/' . $news->ThumbImage . '') }}" alt="">
                        </div>
                        <div class="single_post_text">
